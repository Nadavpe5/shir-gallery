      ...
      <div className="w-full px-4 sm:px-6 lg:px-10 xl:px-14 py-6 sm:py-10">
        <div className="flex items-center justify-between mb-6 sm:mb-10">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-indigo-100 text-indigo-700 rounded-lg px-5 py-2.5 text-sm font-medium hover:bg-indigo-200 transition-colors shadow-sm"
          >
        ...
        {loading ? (
          ...
          <div className="text-center py-32 bg-white rounded-xl border border-gray-100">
            ...
            <button
              onClick={() => router.push("/admin/galleries/new")}
              className="inline-flex items-center gap-2 bg-indigo-100 text-indigo-700 rounded-lg px-5 py-2.5 text-sm font-medium hover:bg-indigo-200 transition-colors"
            >
              <Plus className="w-4 h-4" />
              Create Gallery
            </button>
